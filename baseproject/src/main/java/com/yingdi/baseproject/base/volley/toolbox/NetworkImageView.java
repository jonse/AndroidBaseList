...
public class NetworkImageView extends ImageView {
     ...
     */
//	private int mErrorImageId = R.drawable.article_default_pic_middle;
    ...
    void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        // Calculate the max image contentWidth / contentHeight to use while ignoring WRAP_CONTENT dimens.
...
//					setImageBitmap(response.getBitmap());
                    // change by usher
                    setImageBitmap(scalePic(response.getBitmap()));
    ...
    private Bitmap scalePic(Bitmap bitmap) {
        ...
        float rate = (float) screenWidth / width;
        if (width < screenWidth && width > 400) {
            ...
            try {
                resizeBmp = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, false);
