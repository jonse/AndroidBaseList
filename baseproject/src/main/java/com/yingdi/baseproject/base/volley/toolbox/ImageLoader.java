...
public class ImageLoader {
     ...
     * @param maxWidth The maximum contentWidth of the returned image.
     * @param maxHeight The maximum contentHeight of the returned image.
     ...
     * @param maxWidth The max-contentWidth of the output.
     * @param maxHeight The max-contentHeight of the output.
     */
